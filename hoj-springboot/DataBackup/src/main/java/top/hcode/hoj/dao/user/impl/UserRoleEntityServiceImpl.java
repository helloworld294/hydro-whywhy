...
//        ((LogoutAware) authc).onLogout((SimplePrincipalCollection) attribute);
    ...
    private final static List<String> ChineseRole = Arrays.asList("超级管理员", "普通管理员",
            ...
            "用户(禁止提交&禁言)", "题目管理员", "用户(禁止修改个人资料)", "用户(禁止修改个人资料&禁言)");
    ...
    private final static List<String> EnglishRole = Arrays.asList("Super Administrator", "General Administrator",
            ...
            "Normal User(No Submission & Forbidden Words)", "Problem Administrator", "Normal User(No Profile Edit)", "Normal User(No Profile Edit & Forbidden Words)");
